...
for(const marker of ["v2TournamentNav","Accueil","Tournois","Mon club","Joueurs","← Retour","v2x-persistent-nav"]){assert.ok((html+source).includes(marker),`navigation principale conservée dans le module tournoi : ${marker}`);}
