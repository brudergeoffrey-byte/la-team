...
for(const file of ["offline.html","bg.jpg","firebase-sharing.js","organizer-accounts.js","player-experience.js","organizer-lock.js","tournament-timer.js","court-timers.js","round-timer.js","firebase-client.js","vendor/qrcode.min.js","vendor/qrcode-LICENSE.txt","icons/icon-180.png","icons/icon-192.png","icons/icon-512.png","icons/icon-maskable-512.png"]){
...
(async()=>{
  ...
  const updatedSource=swSource.replace("la-team-shell-v18","la-team-shell-v19");
  vm.runInContext("(function(){"+updatedSource+"\n})()",context);online=true;
  await dispatchLifecycle("install");await dispatchLifecycle("activate");
  assert.deepEqual([...stores.keys()],["la-team-shell-v19"],"ancien cache applicatif nettoyé");
