...
for(const file of ["offline.html","bg.jpg","firebase-sharing.js","firebase-client.js","vendor/qrcode.min.js","vendor/qrcode-LICENSE.txt","icons/icon-180.png","icons/icon-192.png","icons/icon-512.png","icons/icon-maskable-512.png"]){
...
(async()=>{
  ...
  const updatedSource=swSource.replace("la-team-shell-v2","la-team-shell-v3");
  vm.runInContext("(function(){"+updatedSource+"\n})()",context);online=true;
  await dispatchLifecycle("install");await dispatchLifecycle("activate");
  assert.deepEqual([...stores.keys()],["la-team-shell-v3"],"ancien cache applicatif nettoyé");
