...
(async()=>{
  ...
  const updatedSource=swSource.replace("la-team-shell-v19","la-team-shell-v20");
  vm.runInContext("(function(){"+updatedSource+"\n})()",context);online=true;
  await dispatchLifecycle("install");await dispatchLifecycle("activate");
  assert.deepEqual([...stores.keys()],["la-team-shell-v20"],"ancien cache applicatif nettoyé");
