...
(async()=>{
  ...
  const updatedSource=swSource.replace("la-team-shell-v10","la-team-shell-v11");
  vm.runInContext("(function(){"+updatedSource+"\n})()",context);online=true;
  await dispatchLifecycle("install");await dispatchLifecycle("activate");
  assert.deepEqual([...stores.keys()],["la-team-shell-v11"],"ancien cache applicatif nettoyé");
