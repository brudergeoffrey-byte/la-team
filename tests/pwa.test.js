...
(async()=>{
  ...
  const updatedSource=swSource.replace("la-team-shell-v13","la-team-shell-v14");
  vm.runInContext("(function(){"+updatedSource+"\n})()",context);online=true;
  await dispatchLifecycle("install");await dispatchLifecycle("activate");
  assert.deepEqual([...stores.keys()],["la-team-shell-v14"],"ancien cache applicatif nettoyé");
