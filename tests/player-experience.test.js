...
for(const expected of ["✅ CYCLE COMPLET ATTEINT","Toutes les rotations idéales ont été effectuées. Vous pouvez terminer le tournoi ou continuer à jouer.","TERMINER LE TOURNOI","CONTINUER À JOUER"]){assert.ok(html.includes(expected),`décision de fin King : ${expected}`);}
